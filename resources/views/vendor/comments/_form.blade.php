        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    <label for="message">Masukkan nama Anda disini:</label>
                ...
                <div class="form-group">
                    <label for="message">Masukkan email Anda disini:</label>
            ...
            <div class="form-group">
                ...
                <div class="invalid-feedback">
                    komentar Anda diperlukan.
                </div>
                {{-- <small class="form-text text-muted"><a target="_blank" href="https://help.github.com/articles/basic-writing-and-formatting-syntax">Markdown</a> cheatsheet.</small> --}}
            </div>
            <button type="submit" class="btn btn-sm btn-primary text-uppercase float-right">Kirim Komentar</button>
        </form>
    </div>
</div>
<br />
