    ...
    <div class="media-body">
        ...
        <div>
            ...
            @can('edit-comment', $comment)
                <button data-toggle="modal" data-target="#comment-modal-{{ $comment->getKey() }}" class="btn btn-sm btn-link text-uppercase">Ubah</button>
            @endcan
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('comments.reply', $comment->getKey()) }}">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="message">Masukkan pesan Anda di sini:</label>
                                    <textarea required class="form-control" name="message" rows="3" autofocus></textarea>
                                    {{-- <small class="form-text text-muted"><a target="_blank" href="https://help.github.com/articles/basic-writing-and-formatting-syntax">Markdown</a> cheatsheet.</small> --}}
                                </div>
                            </div>
                            <div class="modal-footer">
